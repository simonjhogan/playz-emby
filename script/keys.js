...
KEYS.prototype.open = function(query, settings) {
	...
	dom.append("#" + self.id + "View", {
		...
		childNodes: [{
				...
				text: self.settings.switch.lower,
				dataset: {
				...
				text: self.settings.switch.upper,
				dataset: {
					keyLeft: "#" + this.id + "SelectLower",
				...
				className: "key-set-select-item key",							
				text: self.settings.switch.symbol,
				dataset: {
	...
	dom.append("#" + self.id + "View", {
		...
		childNodes: [{
				...
				text: self.settings.actions.delete,
				dataset: {
					ref: 'delete',
					key: self.settings.actions.delete,
					keyLeft: "#" + this.id + "ActionSpace",
					keyUp: ".key-row .key-focus",					
